...
<body class="   rounded-btns ">
        ...
        <header class="header-1 " id="page-header">
                        ...
                        <form class="nav-search search-form" role="search" method="get" action="#">
                                <div class="search-wrapper">
                                        ...
                                        <input class="search-input" type="search" placeholder="Search..."
                                                name="searchInput" autofocus="autofocus" />
                ...
                <!--== top bar-->
                <div class="bar-top" style="background-color: #202020;">
                        <div class="container">
                                                        ...
                                                        <div class="info-list-inner">
                                                                <div class="info info-panel-logo">
                                                                        <div class="logo"><img
                                                                                        ...
                                                                                        src="assets/images/logo/logo-dark-colored.png"
                                                                                        alt="logo" /></div>
                                                                        ...
                                                                        <div class="info-text">
                                                                                <p class="text">Lorem ipsum dolor sit
                                                                                        ...
                                                                                        elit. Minus
                                                                                        praesentium consequuntur cumque
                                                                                        labore modi voluptatum fugit
                                                                                        animi tempore
                                                                                        id perspiciatis!</p>
                                                                        </div>
                                                                </div>
                                                                ...
                                                                <div class="info">
                                                                        ...
                                                                        <div class="info-text"><span class="text"> our
                                                                                        location</span><span
                                                                                        class="sub-text"> 536 xyz st.,
                                                                                        abc, Alexandria, Egypt </span>
                                                                        </div>
                                                                </div>
                                                                <div class="info">
                                                                        <div class="info-icon"><i
                                                                                        class="far fa-envelope  icon"></i>
                                                                        </div>
                                                                        <div class="info-text"><span class="text ">email
                                                                                        address</span><a
                                                                ...
                                                                <div class="info">
                                                                        <div class="info-icon"> <i
                                                                                        class="fas fa-mobile-alt  icon"></i>
                                                                        </div>
                                                                        <div class="info-text"><span class="text ">call
                                                                                        us</span><a
                                                                                        class="sub-text info-link"
                                                                                        href="tel:(800)123-0045-1254">(800)123-0045-1254</a>
                                                                        </div>
                                                                </div>
                                                        </div>
        ...
        <!--End Page Header-->
        <!-- Start  Page hero-->
        <section class="page-hero hero-image-bg d-flex align-items-center" id="page-hero">
                <div class="particles-js  dots" id="particles-js"></div>
                <div class="overlay-photo-image-bg" data-background="assets/images/hero/hero-bg-3.jpg"></div>
                        ...
                        <div class="hero-text-area text-center ">
                                <div class="row">
                                        <div class="col-12 col-lg-10 mx-auto">
                                                <h1 class="hero-title  wow fadeInUp " data-wow-delay=".2s"> <span
                                                                class="first-word hollow-text">reach<span
                                                                        class="title-design-element  "></span></span>
                                                        your business <br>next level with<span class="featured-text">
                                                                Consulto</span>
                                                </h1>
                                        </div>
                                        <div class="col-10 col-md-8 mx-auto">
                                                <p class="hero-subtitle  wow fadeInUp " data-wow-delay=".4s">
                                                        Lorem ipsum dolor sit amet, consectetur perspiciatis elit. Sed
                                                        architecto dolorum inventore
                                                        totam adipisci provident placeat
                                                </p>
                                        </div>
                                                                ...
                                                                <div class="mc-form-area " id="mc_embed_signup">
                                                                        <form class="validate mc-form one-field-form"
                                                                                ...
                                                                                <div id="mc_embed_signup_scroll">
                                                                                        <div
                                                                                                class="mc-field-group field-group ">
                                                                                                <label class="d-none"
                                                                                                        for="search">search</label>
                                                                                                <input class="required  search"
                                                                                                        type="text"
                                                                                                        value="Search"
                                                                                                        name="search"
                                                                                                        id="mce-EMAIL"
                                                                                                ...
                                                                                                <div style="position: absolute; left: -5000px;"
                                                                                                        aria-hidden="true">
                                                                                                        <input type="text"
                                                                                                                name="b_59442f002934450af13bdfe82_f85a400e6a"
                                                                                                                tabindex="-1"
                                                                                                                value="">
                                                                                                </div>
                                                                                        </div>
                                                                                        <div class="clear cta-area">
                                                                                                <input class="button btn-solid subscribe-btn"
                                                                                                        type="submit"
                                                                                                        value="Search"
                                                                                                        name="subscribe"
                                                                        ...
                                                                        <div class="mailchimp-alerts">
                                                                                <div class="mc-msg mc-submitting">
                                                                                </div>
        ...
        <section class="services services-boxed has-shifted-down-stats is-dark mega-section  " id="services">
                <div class="container">
                        <div class="section-heading center-heading">
                                <h2 class="section-title  wow fadeInUp" data-wow-delay=".2s"><span
                                                class='hollow-text'>services</span>
                        ...
                        <div class="row  services-row">
                                <div class="col-12 col-md-9  col-lg-4 mx-auto">
                                        ...
                                        <div class="service-box  wow fadeInUp featured" data-wow-offset="0"
                                                data-wow-delay=".2s" data-tilt="data-tilt">
                                                <div class="service-icon"><i class="fas fa-pencil-ruler font-icon"></i>
                                                </div><span class="service-num hollow-text">1 </span>
                                                <div class="service-content">
                                                        <h3 class="service-title">Business Registration</h3>
                                                        <p class="service-text">
                                                                We help you register your business
                                                        </p>
                                                </div>
                                                <button type="button" class="btn btn-dark is-dark" data-toggle="modal"
                                                        data-target="#myModal">
                                                        read more
                                                </button>
                                        </div>
                                ...
                                <div class="col-12 col-md-9  col-lg-4 mx-auto">
                                        ...
                                        <div class="service-box  wow fadeInUp " data-wow-offset="0" data-wow-delay=".6s"
                                                ...
                                                <div class="service-icon"><i
                                                                class="fas fa-drafting-compass font-icon"></i></div>
                                                <span class="service-num hollow-text">2 </span>
                                                <div class="service-content">
                                                        <h3 class="service-title">Government Registration</h3>
                                                        <p class="service-text">
                                                                Get government registration certificates
                                                        </p>
                                                </div>
                                                <button type="button" class="btn btn-dark is-dark" data-toggle="modal"
                                                        data-target="#myModal">
                                ...
                                <div class="col-12 col-md-9  col-lg-4 mx-auto">
                                        ...
                                        <div class="service-box  wow fadeInUp " data-wow-offset="0" data-wow-delay=".4s"
                                                data-tilt="data-tilt">
                                                <div class="service-icon"><i class="fas fa-layer-group font-icon"></i>
                                                </div><span class="service-num hollow-text">3 </span>
                                                <div class="service-content">
                                                        <h3 class="service-title">Government Licenses</h3>
                                                        <p class="service-text">
                                                                Getting govt. licenses with us is easy
                                                        </p>
                                                </div><a class="read-more" href="#0">read more<i
                                ...
                                <div class="col-12 col-md-9  col-lg-4 mx-auto">
                                        ...
                                        <div class="service-box  wow fadeInUp " data-wow-offset="0" data-wow-delay=".2s"
                                                data-tilt="data-tilt">
                                                <div class="service-icon"><i class="fas fa-rocket font-icon"></i></div>
                                                <span class="service-num hollow-text">4 </span>
                                                <div class="service-content">
                                                        <h3 class="service-title">RBI Regulatory</h3>
                                                        <p class="service-text">
                                                                Streamline compliance with our experts
                                                        </p>
                                                </div><a class="read-more" href="#0">read more<i
                                                                class="fas fa-arrow-right icon "> </i></a>
                                        </div>
                                ...
                                <div class="col-12 col-md-9  col-lg-4 mx-auto">
                                        ...
                                        <div class="service-box  wow fadeInUp " data-wow-offset="0" data-wow-delay=".4s"
                                                data-tilt="data-tilt">
                                                <div class="service-icon"><i class="fas fa-gavel font-icon"></i></div>
                                                <span class="service-num hollow-text">5 </span>
                                                <div class="service-content">
                                                        <h3 class="service-title">Environment Laws</h3>
                                                        <p class="service-text">
                                                                We ensure eco-sustainable growth
                                                        </p>
                                                </div><a class="read-more" href="#0">read more<i
                                                                class="fas fa-arrow-right icon "> </i></a>
                                        </div>
                                ...
                                <div class="col-12 col-md-9  col-lg-4 mx-auto">
                                        ...
                                        <div class="service-box  wow fadeInUp  " data-wow-offset="0"
                                                data-wow-delay=".6s" data-tilt="data-tilt">
                                                <div class="service-icon"><i
                                                                class="fas fa-comment-dollar font-icon"></i></div><span
                                                        class="service-num hollow-text">6 </span>
                                                <div class="service-content">
                                                        <h3 class="service-title">Tax Filing</h3>
                                                        <p class="service-text">
                                                                We simplify the process of tax filing
                                                        </p>
                                                </div><a class="read-more" href="#0">read more<i
                                                                class="fas fa-arrow-right icon "> </i></a>
                                        </div>
                                ...
                                <div class="col-12 col-md-9  col-lg-4 mx-auto">
                                        ...
                                        <div class="service-box  wow fadeInUp  " data-wow-offset="0"
                                                ...
                                                <div class="service-icon"><i
                                                        ...
                                                        class="service-num hollow-text">6 </span>
                                                <div class="service-content">
                                                        <h3 class="service-title">IPR & NGO</h3>
                                                        <p class="service-text">
                                                                We provide top-notch IPR Services
                                                        </p>
                                                </div><a class="read-more" href="#0">read more<i
                                                                class="fas fa-arrow-right icon "> </i></a>
                                        </div>
                                ...
                                <div class="stats-inner">
                                        ...
                                        <div class="row  g-0 ">
                                                ...
                                                <div class="col-6 col-lg-3 stat-box ">
                                                        <div class="stat-box-inner  "><i
                                                                        class="fas fa-cogs stat-icon"></i>
                                                                <p class="stat-num "><span class="counter"
                                                                                data-from="10" data-to="750"
                                                                                data-speed="3000"
                                                ...
                                                <div class="col-6 col-lg-3 stat-box ">
                                                        <div class="stat-box-inner "><i
                                                                        class="fas fa-business-time stat-icon"></i>
                                                                <p class="stat-num "><span class="counter" data-from="0"
                                                                                data-to="23" data-speed="3000"
                                                                                data-refresh-interval="50"></span><span
                                                                                class="sign">K</span></p>
                                                ...
                                                <div class="col-6 col-lg-3 stat-box ">
                                                        <div class="stat-box-inner "><i
                                                                        class="fas fa-users stat-icon"></i>
                                                                <p class="stat-num "><span class="counter" data-from="0"
                                                                                data-to="200" data-speed="3000"
                                                                                data-refresh-interval="50"></span><span
                                                                                class="sign">+</span></p>
                                                ...
                                                <div class="col-6 col-lg-3 stat-box ">
                                                        <div class="stat-box-inner "><i
                                                                        class="fas fa-layer-group stat-icon"></i>
                                                                <p class="stat-num "><span class="counter" data-from="0"
                                                                                data-to="28" data-speed="3000"
                                                                                data-refresh-interval="50"></span><span
                                                                                class="sign"> </span> </p>
        ...
        <section class="portfolio  mega-section   " id="portfolio">
                <div class="container">
                        <div class="section-heading center-heading">
                                <h2 class="section-title  wow fadeInUp" data-wow-delay=".2s"><span
                                                class='hollow-text'>portfolio</span>
                                        of our work<span class="title-design-element "></span></h2>
                                <div class="line line-on-center wow fadeIn" data-wow-delay=".7s"></div>
                        </div>
                        ...
                        <div class=" see-more-area   wow fadeInUp" data-wow-delay="0s"> <a class=" btn-solid "
                                        href="portfolio-grid.html">see our portfolio</a></div>
                        <!--End .see-more-area-->
                </div>
        </section>
        ...
        <section class="about  dark-section mega-section p-0" id="about">
                <div class="container-fluid px-0">
                        ...
                        <div class="content-block  wide-section ">
                                <div class="row  g-0 ">
                                        <div class="col-12 col-lg-6 d-flex align-items-center   about-col wow fadeIn"
                                                data-wow-delay="0.4s">
                                                <div class="wide-img-area   "><img src="assets/images/about/1.jpg"
                                                                alt="show case wide image">
                                                </div>
                                        ...
                                        <div class="col-12 col-lg-6   d-flex align-items-center  about-col  wow fadeInUp"
                                                ...
                                                <div class="text-area "><span class="tag-line">about Us</span>
                                                        <div class="section-heading side-heading  light-title">
                                                                <h2 class="section-title "> trusted by worldwide clients
                                                                        since<span class='featured-text'>
                                                                                1975.</span><span
                                                                                class="title-design-element "></span>
                                                                </h2>
                                                        </div>
                                                        <p class=" init-text">
                                                                Lorem ipsum dolor, sit amet consectetur adipisicing
                                                                elit. Distinctio, aliquam est! rerum
                                                                inventore animi at iusto totam sunt accusamus quia
                                                        ...
                                                        <div class="cta-area wow fadeInUp" data-wow-delay=".8s"><a
                                                                        class=" btn-solid " href="about-us-1.html">Learn
                                                                        more</a>
                                                                <div class="signature ">
                                                                        <div class="signature-img"></div>
                                                                        <div class="signature-name">CEO &amp; Founder
                                                                        </div>
                                                                </div>
                                                        </div>
                                                </div>
        ...
        <section class="our-clients   elf-section" id="our-clients">
                <div class="container">
                        ...
                        <div class=" clients-logos d-flex align-items-center justify-content-around flex-wrap">
                                ...
                                <div class="swiper-container">
                                        <div class="swiper-wrapper clients-logo-wrapper wow fadeIn "
                                                data-wow-delay=".02s">
              ...
              -->
                                                <div class="swiper-slide">
                                                        <div class="client-logo  "><a href="#0"><img
        ...
        <section class="our-team mega-section " id="our-team">
                <div class="container">
                        <div class="section-heading center-heading">
                                <h2 class="section-title  wow fadeInUp" data-wow-delay=".2s"> our <span
                                                class='hollow-text'>Experts</span> team members<span
                                ...
                                <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
                                        <div class="tm-member-card   wow   fadeInUp" data-wow-delay="0.2s"
                                                ...
                                                <div class="tm-details">
                                                        ...
                                                        </a><span class="tm-role">Founder </span>
                                                </div>
                                        </div>
                                </div>
                                <!--Second Team Member-->
                                <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
                                        <div class="tm-member-card   wow   fadeInUp" data-wow-delay="0.4s"
                                                ...
                                                <div class="tm-details">
                                                        ...
                                                        </a><span class="tm-role">lawyer </span>
                                                </div>
                                        </div>
                                </div>
                                <!--Third Team Member-->
                                <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
                                        <div class="tm-member-card   wow   fadeInUp" data-wow-delay="0.6s"
                                                ...
                                                <div class="tm-details">
                                                        ...
                                                        </a><span class="tm-role">accountant </span>
                                                </div>
                                        </div>
                                </div>
                        </div>
                ...
                <div class="see-more-area   wow fadeInUp" data-wow-delay="0.8s"><a class=" btn-solid"
                                href="our-team.html">all
                                team members </a></div>
        </section>
        <!-- End  our-team Section-->
        <!-- Start  testimonials Section-->
        <section class="testimonials bg-img-section testimonials-1-col off-grid bg-img-section d-flex align-items-center mega-section   "
                ...
                <div class="container">
                        <div class="row d-flex align-items-center">
                                <div class="col-12 col-lg-4 ">
                                        ...
                                        <div class="section-heading side-heading light-title ">
                                                <h2 class="section-title wow fadeInUp" data-wow-delay=".2s">our clients
                                                        Feedback about their
                                                        experience with us<span class="title-design-element "></span>
                                                </h2>
                                        </div>
                                        <!--Start .see-more-area-->
                                        <div class=" see-more-area d-none  d-lg-flex justify-content-start wow fadeInUp "
                                                data-wow-delay="0.4s"><a class=" btn-solid "
                                                        href="testimonials.html">see all testimonials</a>
                                        </div>
                                ...
                                <div class="col-12 col-lg-8">
                                        <div class="swiper-container  wow fadeIn  " data-wow-delay="0s">
                                                        ...
                                                        <div class="swiper-slide">
                                                                <div
                                                                        ...
                                                                        <div class="testimonial-content">
                                                                                ...
                                                                                <div class="customer-testimonial"><i
                                                                                                class="fas fa-quote-left   icon"></i>
                                                                                        <div class="rating-stars"><i
                                                                                                        class="fas fa-star star-icon"></i><i
                                                                                                        class="fas fa-star star-icon"></i><i
                                                                                                        class="fas fa-star star-icon"></i><i
                                                                                                        class="fas fa-star star-icon"></i><i
                                                                                                        class="fas fa-star star-icon off"></i>
                                                                                        </div>
                                                                                        <div class="content">
                                                                                                <p
                                                ...
                                                <div class="swiper-button-next">
                                                        <div class="right-arrow"><i
                                                                        class="fas fa-arrow-right icon "></i>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
                        ...
                        <div class=" see-more-area d-block d-lg-none wow fadeInUp text-center" data-wow-delay="0.4s"><a
                                        class=" btn-solid " href="testimonials.html">see all testimonials</a></div>
                        <!--End Of .see-more-area           -->
                </div>
        </section>
                ...
                <div class="container ">
                        <div class="section-heading center-heading">
                                <h2 class="section-title  wow fadeInUp" data-wow-delay=".2s">latest <span
                                                class='hollow-text'>news</span><span
                                                class="title-design-element "></span></h2>
                                <div class="line line-on-center wow fadeIn" data-wow-delay=".7s"></div>
                        </div>
                        <div class="row ">
                                                                ...
                                                                <div class="post-box">
                                                                        ...
                                                                        <div class="post-summary">
                                                                                ...
                                                                                <div class="post-info"><a
                                                                                                ...
                                                                                                class="info post-author"
                                                                                                href="#"> <i
                                                                                                        class=" fas fa-user icon"></i>Allan
                                                                                                Moore</a></div>
                                                                                <div class="post-text">
                                                                                        <a class="post-link"
                                                                                        ...
                                                                                        <p class="post-excerpt">Lorem
                                                                                                ipsum dolor sit, amet
                                                                                                consectetur adipisicing
                                                                                                elit.Iure nulla dolorem,
                                                                                                voluptates molestiae</p>
                                                                                        <a class="read-more"
                                                                                                href="post-single.html">read
                                                                                                more<i
                                                                                                        class="fas fa-arrow-right icon "></i></a>
                                                                                </div>
                                                                        </div>
                                                                ...
                                                                <div class="post-box">
                                                                        ...
                                                                        <div class="post-summary">
                                                                                ...
                                                                                <div class="post-info"><a
                                                                                                class="info post-cat"
                                                                                                href="#"> <i
                                                                                                        class=" fas fa-list-alt icon"></i>life
                                                                                                style</a><a
                                                                                                class="info post-author"
                                                                                                href="#"> <i
                                                                                                        class=" fas fa-user icon"></i>yusuf
                                                                                                amin</a></div>
                                                                                <div class="post-text">
                                                                                        <a class="post-link"
                                                                                                href="post-single.html">
        ...
        <section class="take-action mega-section " id="take-action">
                ...
                <div class="cta-wrapper">
                        <div class="container">
                                <div class="section-heading center-heading">
                                        <h2 class="section-title  wow fadeInUp" data-wow-delay=".2s">Still Have More
                                                <span class='hollow-text'>Questions</span>?<span
                                                        class="title-design-element "></span>
                                        </h2>
                                        <p class="section-subtitle wow fadeInUp" data-wow-delay=".6s">Lorem ipsum dolor
                                                sit amet consectetur
                                                adipisicing elit. Sunt, architecto cupiditate odio rerum est</p>
                                        <div class="line line-on-center wow fadeIn" data-wow-delay=".7s"></div>
                                </div>
                                <!--Start .see-more-area-->
                                <div class=" see-more-area wow fadeInUp" data-wow-delay="0.8s"><a
                                                class=" btn-solid cta-link" href="contact-us.html">get in toutch</a>
                                </div>
                                <!--End Of .see-more-area        -->
                        </div>
                </div>
                ...
                <div class="container">
                        <div class="row footer-cols">
                                <div class="col-12 col-md-8 col-lg-4  footer-col wow fadeInUp " data-wow-delay="0.3s">
                                        <img class="img-fluid footer-logo" src="assets/images/logo/logo-light.png"
                                                alt="logo" />
                                        <div class="footer-col-content-wrapper">
                                                <p class="footer-text-about-us ">
                                                        Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                                                        Voluptatibus facere modi possimus
                                                        dignissimos, aliquam nobis eaque? Voluptatem magnam quisquam
                                                        rem.
                                                ...
                                                <div class="social-icons">
                                                        <div class="sc-wrapper dir-row sc-size-32">
                                                                <ul class="sc-list">
                                                                        ...
                                                                        <li class="sc-item " title="instagram"><a
                                                                                        class="sc-link" href="#0"><i
                                                                                                class="fab fa-instagram sc-icon"></i></a>
                                                                        </li>
                                                                        <li class="sc-item " title="twitter"><a
                                ...
                                <div class="col-12 col-md-8   col-lg-4 footer-col wow fadeInUp " data-wow-delay=".9s">
                                        ...
                                        <div class="footer-col-content-wrapper">
                                                ...
                                                <div class="contact-info-card"><i
                                                                class="fas fa-globe-africa icon"></i><a
                                                                class="text-lowercase  info"
                                                                href="#0">www.yoursite.com</a></div>
                                                <div class="contact-info-card"><i
                                                                class="fas fa-map-marker-alt icon"></i><span
                                                                class="text-lowercase  info">5 Xyz st., Abc, alexandria,
                                                                egypt.</span></div>
                                                <div class="contact-info-card"><i class="fas fa-mobile-alt icon"></i><a
                                                                class="info" href="tel:+20123456789">+20123456789 </a>
                                                </div>
                                        </div>
                                </div>
                        </div>
                ...
                <div class="copyrights ">
                        <div class="container">
                                <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                                <div class="terms-links"><a href="#0">Terms of Use </a> | <a
        ...
        <div class="chat-pop-up-window">
                <button type="button"><img src="img/chat-icon.png" alt="Corpbiz Chat"></button>
        </div>

        <div class="fixed-fullscreen-chat" style="display:none">
                <ul class="list-unstyled chat-option-list">
                        <li>
                                <a href="#" target="_blank" class="for-dekstop">
                                        <div class="d-flex align-items-center"><img src="img/whatsapp-icon.png"
                                                        alt="whatsaap">
                                                <p class="m-0 ml-2">Chat on Whatsapp</p>
                                        </div>
                                </a>
                                <a href="whatsapp://send?phone=919289379709&text=Hi Corpbiz" class="for-mobile">
                                        <div class="d-flex align-items-center"> <img src="img/whatsapp-icon.png"
                                                        alt="whatsaap">
                                                <p class="m-0 ml-2">Chat on Whatsapp</p>
                                        </div>
                        ...
                        <li>
                                <a id="tars-widget-fab" href="#"
                                        onclick="if (!window.__cfRLUnblockHandlers) return false; chatbotNavigate()"
                                        data-cf-modified-65d709a6f32e312eb21271ef->
                                        <div class="d-flex align-items-center">
                                                <i class="fa fa-comment" style="color: #1ad51f;"></i>
                                                <p class="m-0 ml-2">Hey I'm Ruchi. Let's Talk!</p>
                                        </div>
                                </a>
                        </li>

                </ul>
                <button type="button" class="close-chat-pop-up"><i class="fa fa-times"></i></button>
        </div>
        <script type="65d709a6f32e312eb21271ef-text/javascript">
                superplaceholder({
                        el: searchKey,
                        sentences: ['Company Registration', 'GST Registration', 'FSSAI License',
                                'Music License',
        ...
        <div class="open-iframe" style="display:none;">
                <iframe id="chatbotFrameURL" webkitallowfullscreen mozallowfullscreen src width="100%" height="100%"
                        frameborder="0"></iframe>
                <button type="button" class="close-iframe bg-transparent border-none text-white font-weight-bold"><i
                                class="fa fa-times"></i></button>
        </div>
        <script type="65d709a6f32e312eb21271ef-text/javascript">
                $('.fixed-fullscreen-chat').hide();
                setTimeout(function() {
                        $('.fixed-fullscreen-chat').show();
                }, 6000);
                $('.chat-pop-up-window').click(function() {
                        $('.fixed-fullscreen-chat').toggle();
                });
                $('.close-chat-pop-up').click(function() {
                        $('.fixed-fullscreen-chat').hide();
                });
                $('.open-iframe').hide();
                $('#tars-widget-fab').click(function() {
                        $('.open-iframe').show();
                });
                $('.close-iframe').click(function() {
                        $('.open-iframe').hide();
                        $('.fixed-fullscreen-chat').hide();
                        document.getElementById("chatbotFrameURL").src = "";
                });

                function chatbotNavigate() {
                        document.getElementById("chatbotFrameURL").src = "https://convbot.hellotars.com/conv/B9dMoV";
                }
        </script>
        ...
        <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
                data-cf-settings="65d709a6f32e312eb21271ef-|49" defer></script>

        <!--start popupdiv-->
        <div class="pop-fixed" id="alertPopDiv" style="display: flex;">
                <img src="admin/style/images/icon-logo.jpg" alt="">
                <div class="ml-2">
                        <span id="alertPop">
                                <h4>soni francis</h4>
                                <p>From Chennai Recently Purchased @12AA And 80G Registration</p>
                        </span>
                        <input type="hidden" id="alertEID" value="17">
                </div>
                <button type="button" onclick="if (!window.__cfRLUnblockHandlers) return false; closewidepop()"
                        class="close-wide-pop"><i class="fa fa-times"></i></button>
        </div>
        <!--End popupdiv-->
        <!--     JQuery     -->
